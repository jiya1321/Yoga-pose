...
let poseList = [
  'Vrukshasana', 'Utkasana','Bhujangasana','Veerabhadrasana','Adhomukasana','No_Pose','Sarvangasana','Trikonasana'
]
  ...
  const detectPose = async (detector, poseClassifier, countAudio) => {
    if (
      ...
      try {
        ...
        function findIndexGreaterTha(array, value) {
            var note = 0
            ...
            const classNo=findIndexGreaterTha(data[0],0.99)
            console.log(classNo)
          ...
          const temp = data[0][classNo]*100
          const acc = temp.toFixed(2)
          setAccuracy(acc)
  ...
  return (
    ...
    >
      ...
      <Instructions
        ...
        /> */}
      <button
          onClick={startYoga} style={{top:400}}
          className="secondary-btn"    
        >Start Pose</button>
